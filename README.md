...
![Fullscreen controller list, light mode](assets/01-fullscreen-interface.png)
> Fullscreen controller list, light mode, with live data populated highlighting missing Vatsim flight plan.

![Dark mode with Settings open](assets/02-darkmode-settings.png)
> Dark mode, with the Settings dialog open.

![Split-screen mode](assets/03-splitscreen-controller.png)
