...
A companion app for [vPilot](https://vpilot.rosscarlson.dev/) that surfaces the online VATSIM controller list and two-way chat on a second screen (built for use as an Android EFB alongside Navigraph in a home cockpit).
